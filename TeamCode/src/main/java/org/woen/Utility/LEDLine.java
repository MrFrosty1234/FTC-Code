...
public class LEDLine {
    ...
    public LEDLine(HardwareMap hardwareMap, String name, SignalPin pin) {
        this(hardwareMap, name, 0.999999, 0.650051, pin);
    }

    public LEDLine(HardwareMap hardwareMap, String name, double maxBorder, double minBorder, SignalPin pin) {
